...
var pie = {
  ...
  draw: function draw(_ref2, _ref3) {
    ...
    var connectPoint1 = (0, index$2._util.getCircleRadianPoint)(rx, ry, or, endAngle).map(function (p) {
      return parseInt(p) + 0.5;
    });
    var connectPoint2 = (0, index$2._util.getCircleRadianPoint)(rx, ry, ir, startAngle).map(function (p) {
      return parseInt(p) + 0.5;
    });
...
var agArc = {
  ...
  draw: function draw(_ref5, _ref6) {
    ...
    gradient = gradient.map(function (cv) {
      return (0, index._color.getColorFromRgbValue)(cv);
    });
    ...
    for (var i = 0; i < gradientArcNum; i++) {
      ctx.beginPath();
      var startPoint = (0, index$2._util.getCircleRadianPoint)(rx, ry, r, startAngle + angleGap * i);
      var endPoint = (0, index$2._util.getCircleRadianPoint)(rx, ry, r, startAngle + angleGap * (i + 1));
      var color = (0, index$2.util.getLinearGradientColor)(ctx, startPoint, endPoint, [gradient[i], gradient[i + 1]]);
...
(0, index.lib.extendNewGraph)('pie', pie);
(0, index.lib.extendNewGraph)('agArc', agArc);
(0, index.lib.extendNewGraph)('numberText', numberText);
(0, index.lib.extendNewGraph)('lineIcon', lineIcon);

exports._util2 = index$2.util;
exports.require$$3 = index.lib;
//# sourceMappingURL=index-13c4b549.js.map
