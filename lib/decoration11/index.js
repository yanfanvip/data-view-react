  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      React__default.createElement('polygon', {
        fill: index$3.lib_9(mergedColor[1] || defaultColor[1], 10),
      ...
      React__default.createElement('polygon', {
        fill: index$3.lib_9(mergedColor[0] || defaultColor[0], 20),
        stroke: mergedColor[0],
        points: '\n            20 10, 5 ' + height / 2 + ' 20 ' + (height - 10) + '\n            ' + (width - 20) + ' ' + (height - 10) + ' ' + (width - 5) + ' ' + height / 2 + ' ' + (width - 20) + ' 10\n          '
      }),
      React__default.createElement('polyline', {
        fill: 'transparent',
        stroke: index$3.lib_9(mergedColor[0] || defaultColor[0], 70),
