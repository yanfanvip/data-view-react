...
var index = require('./index-cd27b7f6.js');
var index$1 = require('./index-13c4b549.js');
...
function changeDefaultConfig(key, config) {
  ...
  (0, index$1._util2.deepMerge)(allConfig["".concat(key, "Config")], config);
}
...
function mergeColor(chart) {
  ...
  var defaultColor = (0, index$2._util.deepClone)(config.colorConfig, true);
  var color = option.color,
      series = option.series;
  if (!series) series = [];
  if (!color) color = [];
  option.color = color = (0, index$1._util2.deepMerge)(defaultColor, color);
...
var _classCallCheck2 = index$2._interopRequireDefault(index.require$$1);
...
function title(chart) {
  ...
  if (option.title) {
    title[0] = (0, index$1._util2.deepMerge)((0, index$2._util.deepClone)(config.titleConfig, true), option.title);
  }
...
var _defineProperty2 = index$2._interopRequireDefault(index.require$$0);
...
function grid(chart) {
  ...
  grid = (0, index$1._util2.deepMerge)((0, index$2._util.deepClone)(config.gridConfig, true), grid || {});
  (0, updater_class.doUpdate)({
    chart: chart,
    series: [grid],
    key: 'grid',
...
function mergeDefaultAxisConfig(allAxis) {
  ...
  xAxis = xAxis.map(function (axis) {
    return (0, index$1._util2.deepMerge)((0, index$2._util.deepClone)(config.xAxisConfig), axis);
  });
  yAxis = yAxis.map(function (axis) {
    return (0, index$1._util2.deepMerge)((0, index$2._util.deepClone)(config.yAxisConfig), axis);
  });
...
function getSeriesMinMaxValue(series) {
  ...
  var minValue = Math.min.apply(Math, (0, _toConsumableArray2["default"])(series.map(function (_ref9) {
    var data = _ref9.data;
    return Math.min.apply(Math, (0, _toConsumableArray2["default"])((0, index$1._util2.filterNonNumber)(data)));
  })));
  var maxValue = Math.max.apply(Math, (0, _toConsumableArray2["default"])(series.map(function (_ref10) {
    var data = _ref10.data;
    return Math.max.apply(Math, (0, _toConsumableArray2["default"])((0, index$1._util2.filterNonNumber)(data)));
  })));
  return [minValue, maxValue];
}

function mergeStackData(series) {
  var seriesCloned = (0, index$2._util.deepClone)(series, true);
  series.forEach(function (item, i) {
    var data = (0, index$1._util2.mergeSameStackData)(item, series);
...
function getTickLinePosition(axisType, boundaryGap, position, tickPosition, gap) {
  ...
  var tickLinePosition = tickPosition.map(function (lineStart) {
    var lineEnd = (0, index$2._util.deepClone)(lineStart);
    lineEnd[index] += plus;
    return [(0, index$2._util.deepClone)(lineStart), lineEnd];
  });
...
function getLabelRealPosition(points, position) {
  ...
  points = (0, index$2._util.deepClone)(points);
  points[index] += plus;
  return points;
}
...
function getLabelStyle(axisItem, shapes) {
  ...
  style = (0, index$1._util2.deepMerge)(align, style);
...
function getNameStyle(axisItem) {
  ...
  return (0, index$1._util2.deepMerge)(align, style);
}
...
var _bezierCurve = index$2._interopRequireDefault(index.require$$4);
...
function line(chart) {
  ...
  if (xAxis && yAxis && series) {
    lines = (0, index$1._util2.initNeedSeries)(series, config.lineConfig, 'line');
...
function calcLinesPosition(lines, chart) {
  ...
  return lines.map(function (lineItem) {
    var lineData = (0, index$1._util2.mergeSameStackData)(lineItem, lines);
...
function getLineLength(points) {
  ...
  if (!smooth) return (0, index$1._util2.getPolylineLength)(points);
...
function bar(chart) {
  ...
  if (xAxis && yAxis && series) {
    bars = (0, index$1._util2.initNeedSeries)(series, config.barConfig, 'bar');
...
function calcBarValueAxisCoordinate(bars) {
  return bars.map(function (bar) {
    var data = (0, index$1._util2.mergeSameStackData)(bar, bars);
...
function getBarStyle(barItem, i) {
  ...
  var gradientColor = (0, index$1._util2.deepMerge)(fillColor, gradient.color);
...
function getStartLeftEchelonShape(shape, barItem) {
  ...
  shape = (0, index$2._util.deepClone)(shape);
  var _shape = shape,
...
function getLabelStyle(barItem) {
  ...
  style = (0, index$1._util2.deepMerge)({
    fill: color
  }, style);
  return style;
}
...
function pie$1(chart) {
  ...
  if (!series) series = [];
  var pies = (0, index$1._util2.initNeedSeries)(series, pie.pieConfig, 'pie');
...
function calcPiesPercent(pies) {
  pies.forEach(function (pie) {
    ...
    var percentSumNoLast = (0, index$1._util2.mulAdd)(data.slice(0, -1).map(function (_ref5) {
...
function getDataSum(data) {
  return (0, index$1._util2.mulAdd)(data.map(function (_ref6) {
...
function getDataAngle(data, i) {
  ...
  var percentSum = (0, index$1._util2.mulAdd)(needAddData.map(function (_ref7) {
...
function getPieInsideLabelPos(pieItem, dataItem) {
  ...
  return index$2._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(center).concat([radius, angle]));
}
...
function calcPiesEdgeCenterPos(pies) {
  pies.forEach(function (pie) {
    ...
    data.forEach(function (item) {
      ...
      var pos = index$2._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(center).concat([radius[1], centerAngle]));
...
function addLabelLineAndAlign(dataItem, pieItem) {
  ...
  dataItem.forEach(function (item) {
    ...
    var bendPoint = index$2._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(center).concat([radius, angle]));
    ...
    item.labelLineLength = (0, index$1._util2.getPolylineLength)(item.labelLine);
    item.align = {
      textAlign: 'left',
      textBaseline: 'middle'
    };
...
function getOutsideLabelStyle(pieItem, i) {
  ...
  return (0, index$1._util2.deepMerge)(_objectSpread({
    fill: color
  }, align), style);
}
});
...
function mergeRadarAxisDefaultConfig(radar) {
  return (0, index$1._util2.deepMerge)((0, index$2._util.deepClone)(config.radarAxisConfig), radar);
}
...
function calcRadarAxisLinePosition(radarAxis) {
  ...
  radarAxis.axisLinePosition = angles.map(function (g) {
    return index$2._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(centerPos).concat([radius, g]));
  });
  return radarAxis;
}
...
function calcRadarAxisLabelPosition(radarAxis) {
  ...
  radarAxis.axisLabelPosition = axisLineAngles.map(function (angle) {
    return index$2._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(centerPos).concat([radius, angle]));
  });
  return radarAxis;
}
...
function getSplitAreaStyle(radarAxis, i) {
  ...
  if (polygon) {
    var point1 = index$2._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(centerPos).concat([ringRadius[0], axisLineAngles[0]]));

    var point2 = index$2._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(centerPos).concat([ringRadius[0], axisLineAngles[1]]));

    lineWidth = (0, index$1._util2.getPointToLineDistance)(centerPos, point1, point2);
  }

  style = (0, index$1._util2.deepMerge)((0, index$2._util.deepClone)(style, true), {
    lineWidth: lineWidth
  });
  if (!color.length) return style;
  var colorNum = color.length;
  return (0, index$1._util2.deepMerge)(style, {
...
function radar(chart) {
  ...
  var series = option.series;
  if (!series) series = [];
  var radars = (0, index$1._util2.initNeedSeries)(series, config.radarConfig, 'radar');
...
function calcRadarPosition(radars, chart) {
  ...
  radars.forEach(function (radarItem) {
    ...
    radarItem.radarPosition = indicator.map(function (_ref, i) {
      ...
      return index$2._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(centerPos).concat([dataRadius, axisLineAngles[i]]));
    });
  });
  return radars;
}
...
function calcRadarLabelPosition(radars, chart) {
  ...
  radars.forEach(function (radarItem) {
    ...
    radarItem.labelPosition = dataRadius.map(function (r, i) {
      return index$2._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(centerPos).concat([r + labelGap, axisLineAngles[i]]));
    });
  });
  return radars;
}
...
function getRadarStyle(radarItem) {
  ...
  var colorRgbaValue = (0, index._color.getRgbaValue)(color);
  colorRgbaValue[3] = 0.5;
  var radarDefaultColor = {
    stroke: color,
    fill: (0, index._color.getColorFromRgbValue)(colorRgbaValue)
  };
  return (0, index$1._util2.deepMerge)(radarDefaultColor, radarStyle);
}
...
function getLabelStyle(radarItem, i) {
  ...
  return (0, index$1._util2.deepMerge)(defaultColorAndAlign, style);
}
});
...
function gauge$1(chart) {
  ...
  var series = option.series;
  if (!series) series = [];
  var gauges = (0, index$1._util2.initNeedSeries)(series, gauge.gaugeConfig, 'gauge');
...
function calcGaugesAxisTickPosition(gauges, chart) {
  gauges.forEach(function (gaugeItem) {
    ...
    gaugeItem.tickPosition = new Array(splitNum).fill(0).map(function (foo, i) {
      ...
      return [index$2._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(center).concat([outerRadius, angle])), index$2._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(center).concat([innerRadius, angle]))];
    });
  });
  return gauges;
}
...
function calcGaugesLabelPositionAndAlign(gauges, chart) {
  gauges.forEach(function (gaugeItem) {
    ...
    var position = tickAngles.map(function (angle, i) {
      return index$2._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(center).concat([tickInnerRadius[i] - labelGap, tickAngles[i]]));
    });
...
function calcGaugesLabelData(gauges, chart) {
  gauges.forEach(function (gaugeItem) {
    ...
    var formatterType = (0, _typeof2["default"])(formatter);
    data = (0, index$1._util2.deepMerge)(value, data).map(function (v, i) {
      var label = v;
  ...
  gauges.forEach(function (gaugeItem) {
    ...
    var detailsPosition = data.map(function (_ref3) {
      ...
      if (position === 'center') {
        ...
        point = index$2._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(center).concat([radius, startAngle]));
      } else if (position === 'end') {
        point = index$2._util.getCircleRadianPoint.apply(void 0, (0, _toConsumableArray2["default"])(center).concat([radius, endAngle]));
      }
...
function getAxisLabelStyle(gaugeItem, i) {
  ...
  return (0, index$1._util2.deepMerge)(_objectSpread({}, labelAlign[i]), style);
}
...
function getGaugeArcStyle(gaugeItem, i) {
  ...
  gradient = gradient.map(function (c) {
    return (0, index._color.getRgbaValue)(c);
  });
  return (0, index$1._util2.deepMerge)({
    lineWidth: lineWidth,
    gradient: gradient
...
function getPointerStyle(gaugeItem) {
  ...
  return (0, index$1._util2.deepMerge)({
    rotate: (0, index$1._util2.radianToAngle)(angle),
    scale: [1, 1],
    graphCenter: center
  }, style);
}
...
function getStartPointerConfig(gaugeItem) {
  ...
  config.style.rotate = (0, index$1._util2.radianToAngle)(startAngle + Math.PI / 2);
  return [config];
}
...
function legend(chart) {
  ...
  if (legend) {
    legend = (0, index$1._util2.deepMerge)((0, index$2._util.deepClone)(config.legendConfig, true), legend);
...
function getBeforeWidth(startIndex, currentIndex, legend) {
  ...
  return (0, index$1._util2.mulAdd)(beforeItem.map(function (_ref2) {
...
function getHorizontalXOffset(data, legend, chart) {
  ...
  var allWidth = (0, index$1._util2.mulAdd)(data.map(function (_ref3) {
...
function getTextStyle(legendItem, i) {
  ...
  return (0, index$1._util2.deepMerge)((0, index$2._util.deepClone)(style, true), align);
}
...
var _cRender = index$2._interopRequireDefault(index$1.require$$3);
...
Charts.prototype.setOption = function (option) {
  ...
  var optionCloned = (0, index$2._util.deepClone)(option, true);
...
var _charts = index$2._interopRequireDefault(charts_class);
...
//# sourceMappingURL=index-fcdce9c7.js.map
